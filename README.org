...
This will create a directory named Hydra that contains documentation
(=docs= directory and =examples= directory), the source code (=src=
directory), and build tools.  Install using these commands:
