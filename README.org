...
If you get an error message from ghc or ghci saying that a package is
needed but is hidden, you can create a file named .ghci containing the
following lines:
...
On some versions of Linux, you may get an error message like this:
