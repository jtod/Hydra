...
-- Several: put several executions in one file
...
module Main where
import Hydra.Core
-- import Hydra.Circuits.Register

------------------------------------------------------------------------
-- Running executable functions of type IO ()
------------------------------------------------------------------------

-- An executable program has type IO (), and both device drivers
...
-- Every device driver should have the type IO ()
...
#+BEGIN_SRC hydra :tangle ../../../cscode/circuits/Hydra/Core/Driver.hs
